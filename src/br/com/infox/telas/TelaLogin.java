...
public class TelaLogin extends javax.swing.JFrame {
    ...
    ResultSet rs = null;
    // fim variaves banco de dados

    public void logar() {
        String sql = "select * from tbusuarios where login=? and senha=?";

        try {
            // capturar a caixa de texto da tela
            ...
            if (rs.next()) {
                // a linha abaixo obtem o conteudo da campo perfil
                String perfil = rs.getString(6);
                // System.out.println(perfil);

                // a linha abaixo faz o tratamento do perfil se abrea a tela com todos recursos ou nao
                ...
                // Seta a lblUsuario com o nome do Usuario
                ...
                JOptionPane.showMessageDialog(null, "Uusuario ou senha invalido");
            }
